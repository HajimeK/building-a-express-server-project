...
function getImageList(dir) {
    var fileList = fs_1.default.readdirSync(dir, { withFileTypes: true });
    var dic = {};
    fileList.forEach(function (file) {
        var full = getFileFullPath(dir, file);
        var stats = fs_1.default.statSync(full);
        if (!stats.isDirectory()) {
            var createdDate = stats.birthtime.getFullYear() + '/'
...
function getImage(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                buffer = fs_1.default.createReadStream(filePath);
...
for (var file in files) {
    ...
    var buffer = getImage(files[file]["fullPath"]);
    //console.log(buffer);
}
